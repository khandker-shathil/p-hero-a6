    ...
    return (
        <div className='container gap-5 mx-auto mt-20'>
            <div className='flex flex-col justify-center items-center my-10 gap-5'>
                ...
                <div>
                    <button onClick={() => {setfilterButton('products')}} className={`btn btn-ghost ${filterButton === 'products'? "bg-linear-to-r  from-blue-600 to-purple-700 rounded-full text-white font-medium p-5" : "btn-outline rounded-full border-0"}`}>Products</button>
                    <button onClick={() => {setfilterButton('cart')}} className={`btn btn-ghost ${filterButton === 'cart'? "bg-linear-to-r  from-blue-600 to-purple-700 rounded-full text-white font-medium p-5" : "btn-outline rounded-full border-0"}`}>Cart({addtoCart.length})</button>
                </div>
            </div>
