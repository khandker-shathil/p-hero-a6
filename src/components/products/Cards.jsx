            ...
            <div key={p2.id} className="max-w-sm w-full rounded-2xl border border-gray-200 p-6 bg-white shadow-sm hover:shadow-md transition">
                <div className='flex-1'>
                    <div className="flex items-start justify-between mb-4">
                        ...
                        {
                            p2.tagType === "best-seller" ? <span className="text-xs font-medium px-3 py-1 rounded-full bg-yellow-100 text-yellow-700">
                        {p2.tag} </span> : p2.tagType === "popular" ? <span className="text-xs font-medium px-3 py-1 rounded-full bg-purple-100 text-purple-700">
                        {p2.tag} </span> : <span className="text-xs font-medium px-3 py-1 rounded-full bg-green-100 text-green-700">
                        {p2.tag}
                        </span> 
                        }
                    </div>
